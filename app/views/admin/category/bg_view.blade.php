...
@section('content')
    ...
    <div id='modal-add' class='modal hide fade' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
        ...
        <form action='".Url()."/zadmin/category/add' method='post' class='form-horizontal' id='form-add-category'>
        <div class='modal-body'>
                ...
                <fieldset>
                    ...
                    <div class='control-group'>											
                        ...
                        <div class='controls'>
                            <input type='text' class='span3' id='name' name='category'>
                        </div> <!-- /controls -->				
                    </div> <!-- /control-group -->
                </fieldset>
        ...
        <div class='modal-footer'>
            <button class='btn' data-dismiss='modal' aria-hidden='true' onclick=\"closeModal('modal-add') \">Close</button>
        ...
        <div class='widget widget-nopad'>
            <div class='widget-header'> <i class='icon-list-alt'></i>
                ...
                <span class='search-right'>
                    <form method='post' action='".url()."/zadmin/category/filter'>";
                        $value='';
                        if(isset($filter)){
                            $value=$filter;
                        }
            ...
            <div class='widget-content'>
                <span class='btn-area'>
                    ...
                    <a class='btn btn-danger btn-margin' onClick=javascript:confirm_table('category','delete') >Delete</a>
                </span>";
                            ...
                            foreach($data as $row){
                                echo"
                                    <tr>
                                        ...
                                        <td>".$row->name."</td>
                                        <td>
                                            <a  onclick=javascript:access_link('category/edit/".$row['id']."','Category')  data-toggle='modal' class='btn btn-info' data-target='#modal-edit'>Edit</a>
                                        </td>
                                    </tr>
                                ";
                            }
